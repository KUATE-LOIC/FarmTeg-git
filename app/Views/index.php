...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/agri/img/favicon.png')?>" rel="icon">
  <link href="<?= base_url('assets/agri/img/apple-touch-icon.png')?>" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="<?= base_url('assets/agri/vendor/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
  <link href="<?= base_url('assets/agri/vendor/bootstrap-icons/bootstrap-icons.css')?>" rel="stylesheet">
  <link href="<?= base_url('assets/agri/vendor/aos/aos.css')?>" rel="stylesheet">
  <link href="<?= base_url('assets/agri/vendor/swiper/swiper-bundle.min.css')?>" rel="stylesheet">
  <link href="<?= base_url('assets/agri/vendor/glightbox/css/glightbox.min.css')?>" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="<?= base_url('assets/agri/css/main.css')?>" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center position-relative py-2">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">

      <a href="index.html" class="logo d-flex align-items-center">
        <!-- Uncomment the line below if you also wish to use an image logo -->
        <img src="<?= base_url('assets/agri/img/logo.png')?>" alt="AgriCulture">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?=site_url('login')?>" class="btn  py-2 px-3  text-success">Login</a></li>
          ...
          <li><a href="<?= site_url('create_form_personnel')?>" class="btn border py-2 px-3 btn-success text-white">Register</a></li>
        </ul>
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="<?= base_url('assets/agri/img/hero_1.jpg')?>" alt="">
        ...
        <div class="carousel-item">
          <img src="<?= base_url('assets/agri/img/hero_2.jpg')?>" alt="">
          <div class="carousel-container">
        ...
        <div class="carousel-item">
          <img src="<?= base_url('assets/agri/img/hero_3.jpg')?>" alt="">
          <div class="carousel-container">
        ...
        <div class="carousel-item">
          <img src="<?= base_url('assets/agri/img/hero_4.jpg')?>" alt="">
          <div class="carousel-container">
        ...
        <div class="carousel-item">
          <img src="<?= base_url('assets/agri/img/hero_5.jpg')?>" alt="">
          <div class="carousel-container">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
              <img src="<?= base_url('assets/agri/img/img_long_5.jpg')?>" alt="Image " class="img-fluid img-overlap" data-aos="zoom-out">
            </div>
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
            <img src="<?= base_url('assets/agri/img/img_sq_1.jpg')?>" alt="Image" class="img-fluid">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<?= base_url('assets/agri/img/img_sq_3.jpg')?>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<?= base_url('assets/agri/img/img_sq_8.jpg')?>" alt="Image" class="img-fluid">
                </div>
              </div>
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<?= base_url('assets/agri/img/img_sq_4.jpg')?>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<?= base_url('assets/agri/img/img_sq_5.jpg')?>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<?= base_url('assets/agri/img/img_sq_6.jpg')?>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
          ...
          <div class="row">
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<?= base_url('assets/agri/img/testimonials/testimonials-1.jpg')?>" alt="Testimonial author">
                <blockquote>
                  <p>
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<?= base_url('assets/agri/img/testimonials/testimonials-2.jpg')?>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<?= base_url('assets/agri/img/testimonials/testimonials-3.jpg')?>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<?= base_url('assets/agri/img/testimonials/testimonials-4.jpg')?>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<?= base_url('assets/agri/img/blog/blog-1.jpg')?>" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<?= base_url('assets/agri/img/blog/blog-2.jpg')?>" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<?= base_url('assets/agri/img/blog/blog-3.jpg')?>" class="img-fluid" alt="">
  ...
  <!-- Vendor JS Files -->
  <script src="<?= base_url('assets/agri/vendor/bootstrap/js/bootstrap.bundle.min.js')?>"></script>
  <script src="<?= base_url('assets/agri/vendor/php-email-form/validate.js')?>"></script>
  <script src="<?= base_url('assets/agri/vendor/aos/aos.js')?>"></script>
  <script src="<?= base_url('assets/agri/vendor/swiper/swiper-bundle.min.js')?>"></script>
  <script src="<?= base_url('assets/agri/vendor/glightbox/js/glightbox.min.js')?>"></script>

  <!-- Main JS File -->
  <script src="<?= base_url('assets/agri/js/main.js')?>"></script>
