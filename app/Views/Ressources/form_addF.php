...
<div class="main-container ">
    <div class="pd-20 card-box mb-30">
        <form action="<?= site_url('insert_ressource')?>" method="POST" id="addFood">
            <div class="row">
                <div class="col-md-6 d-flex justify-content-start mb-3 h3 text-success text-nowrap" style="font-size: 25px;"><?= lang("Text.feedinga")?></div>
                <a class="col-md-2 offset-4 d-flex justify-content-end mb-3 text-info d-flex align-items-center" id="add"><i class="fa fa-plus d-flex align-items-center"></i>&nbsp<?= lang("Text.plus")?>
                </a>
            </div>
                    ...
                    <div class="input-group custom col-md-6 mb-0" >
                        <div class="form-floating">
                            <select class="form-select rounded-0" id="unit" name="unite_ressource[]" aria-label="State">
                                ...
                                <option value="Bags"><?= lang("Text.bags")?>
                                </option>
            ...
            <div class="row d-flex justify-content-end">
                <div class="col-md-1 col-sm-2 offset-sm-3 offset-md-5 w-25">
                    <button class="btn border-light text-danger" style=" background-color: pink;" type="reset"><?= lang("Text.Cancel")?>
                    </button>
                </div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="input-group custom col-md-6 mb-0" >
                                <div class="form-floating">
                                    <select class="form-select rounded-0" id="unit" name="unite_ressource[]" aria-label="State">
                                        <option selected hidden disabled></option>
                                        <option value="Bags"><?= lang("Text.bags")?></option>
                                        <option value="Kg">Kg</option>
                                    </select>
