...
<div class="main-container ">
    <div class="pd-20 card-box mb-30">
        <form action="<?= site_url('insert_ressource')?>" method="post">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-start mb-3 h3 text-success text-nowrap" style="font-size: 25px;">New Treatment Inventory</div>
            </div>
                ...
                <div class="input-group custom col-md-2" >
                    <div class="form-floating">
                        <select class="form-select rounded-0" id="unit" name="unite_ressource" aria-label="State">
                            ...
                            <option value="Cm3">Cm<sub>3</sub></option>
                        </select>
