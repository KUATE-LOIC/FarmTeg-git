        ...
        <div class="min-height-200px">
            <div class="card-box mb-30">
                <div class="pd-20 d-flex justify-content-between">
                    <h2 class="card-title text-blue my-1" style="font-size: 25px;"><?= lang("Text.Stock")?>
                    </h2>

                    <a href="<?= site_url('create_form_mouvement')?>" class="btn btn-success "><span class="mtext text-nowrap"><?= lang("Text.Losses")?>
                    </span></a>
                </div>
                    ...
                    <table class="data-table table stripe hover nowrap">
                        <thead>
                            ...
                            <th class="table-plus">#</th>
                                <th class="datatable-nosort"><?= lang("Text.Product Type")?>
                                </th>
                                <th class="datatable-nosort"><?= lang("Text.Label")?>
                                </th>
                                <th class="datatable-nosort"><?= lang("Text.Quantity")?>
                                </th>
                                <th class="datatable-nosort"><?= lang("Text.Add Date")?>
                                </th>
                        ...
                        <tr>
                            ...
                            <td><?= intval($mouvement['qte_mouvement'])?></td>
