...
<div class="main-container ">
            <div class="pd-20 card-box mb-30">
                <form action="<?= site_url('edit_personnel')?>" method="put">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-start my-3 h3 text-success" style="font-size: 25px;">Update An Employee</div>
                    </div>
                <div class="form-group row mt-2">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <label class="col-sm-4 col-md-1 col-form-label">Gender*</label>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-1 col-sm-2 offset-sm-3 offset-md-5 w-25">
                            <button class="btn border-danger bg-light text-danger" type="reset">Cancel</button>
                        </div>
